...
% plot Extended Data figure 6C: screening results from second Gain-of-Function screen
...
% outfile_FigED6c_heatmap_diltiazem_GoF_screen2 name of output figure file
% intensityNoise = 5000;
...
for spi=1:2
    ...
    for mylabels = 1:2
        ...
        for i=compoundsIDX %16 diltiazem compoundsIDX
            ...
            plot(plotData, 'Color', [222 45 38]/256, 'LineWidth', 2)
    ...
    filename = strrep(outfile_FigED6c_heatmap_diltiazem_GoF_screen2, '.pdf', ['_part',num2str(spi),'_1.pdf']);
    ...
    cmaplength = 40;
    fsize = 6;
    mycmap = ([linspace(222, 256,cmaplength);...
              linspace(45, 256,cmaplength);...
              linspace(38, 256,cmaplength)]/256)';
    ...
    filename = strrep(outfile_FigED6c_heatmap_diltiazem_GoF_screen2, '.pdf', ['_part',num2str(spi),'_2.pdf']);
