...
% plot Extended data figure 6b: screening results from first Gain-of-Function screen
...
% outfile_FigED6b_barplot_diltiazem_GoF_screen1 name of output figure file
% intensityNoise = 5000;
...
print(fig, '-painters', '-dpdf', '-r600', '-bestfit', ...
        outfile_FigED6b_barplot_diltiazem_GoF_screen1)